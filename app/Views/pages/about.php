...
/**
 * File: about.php
 * Chuc nang: Trang gioi thieu cau chuyen, tam nhin va nang luc cong ty.
 * Cach hoat dong: Nap layout chung, hien thi noi dung thuong hieu va feedback
 * khach hang tu database.
 * Noi dat file: project/about.php
 */

$pageTitle = 'Giới thiệu | GreenNest Landscape';
$pageDescription = 'Tìm hiểu GreenNest Landscape, công ty thiết kế decor cây xanh và chăm sóc cây cảnh cho doanh nghiệp, nhà ở và showroom.';
...
$heroVideo = content_value('about.hero_video', 'assets/videos/about/about-hero.m3u8');
...
<section class="page-hero about-hero modern-hero">
    <video
        ...
        playsinline
        preload="metadata"
        aria-label="Video nền giới thiệu GreenNest Landscape"
    ></video>
    <div class="container">
        <div class="row g-5 align-items-end">
            <div class="col-lg-8" data-aos="fade-up">
                <span class="section-kicker">Về GreenNest</span>
                <h1><?php echo e($page['title'] ?? 'Thiết kế mảng xanh bền vững cho không gian sống và làm việc hiện đại.'); ?></h1>
                <p><?php echo e($page['content'] ?? 'GreenNest kết hợp tư duy thiết kế, hiểu biết cây trồng và quy trình chăm sóc định kỳ để tạo nên những không gian xanh đẹp, khỏe và dễ duy trì.'); ?></p>
                <div class="hero-actions">
                    <a href="faq.php" class="btn btn-success px-4">Xem FAQ</a>
                    <a href="faq.php" class="btn btn-outline-light px-4">Xem câu hỏi thường gặp</a>
                </div>
            </div>
        ...
        <div class="row g-5 align-items-center">
            <div class="col-lg-6" data-aos="fade-right">
                <div class="about-image-stack">
                    <?php $aboutImage = empty($page['image']) || preg_match('/^https?:\/\//', $page['image']) ? 'assets/images/Screenshot 2025-12-26 172140.png' : $page['image']; ?>
            ...
            <div class="col-lg-6" data-aos="fade-left">
                ...
                <p>GreenNest không chạy theo bố cục rườm rà. Chúng tôi tập trung vào cây khỏe, chậu đẹp, tỷ lệ hài hòa và quy trình chăm sóc sau bàn giao.</p>
...
<section class="section-padding bg-soft">
    <div class="container">
        <div class="section-heading text-center" data-aos="fade-up">
            ...
            <p>GreenNest xây dựng phương án theo cả thẩm mỹ lẫn chi phí duy trì, phù hợp cho không gian có nhiều người sử dụng.</p>
        </div>
        <div class="row g-4">
        ...
        <div class="row g-5 align-items-start">
            ...
            <div class="col-lg-7" data-aos="fade-left">
                <div class="timeline-list">
                    <article>
                        <span>01</span>
                        <div><h3>Tiếp nhận nhu cầu</h3><p>Nhận ảnh, mặt bằng, phong cách mong muốn và mức ngân sách dự kiến.</p></div>
                    </article>
                    <article>
                        <span>02</span>
                        <div><h3>Khảo sát điều kiện</h3><p>Đánh giá ánh sáng, gió, ổ cắm, lối đi, vị trí tưới và rủi ro bẩn sàn.</p></div>
                    </article>
                    <article>
                        <span>03</span>
                        <div><h3>Đề xuất phương án</h3><p>Gợi ý cây, chậu, bố cục, tần suất chăm sóc và phương án thay thế khi cần.</p></div>
                    </article>
                    <article>
                        <span>04</span>
                        <div><h3>Bàn giao và duy trì</h3><p>Lắp đặt gọn, hướng dẫn chăm sóc, theo dõi cây sau bàn giao và bảo dưỡng định kỳ.</p></div>
                    </article>
                </div>
            </div>
        </div>
...
<section class="section-padding map-section" id="greenNestMap">
    <div class="container">
        <div class="map-layout-row">
            <div class="map-copy-panel" data-aos="fade-right">
                <div>
                    <span class="section-kicker">Vi tri</span>
                    <h2 class="section-title">Ghe GreenNest de chon cay va chau truc tiep</h2>
                    <p class="text-muted"><?php echo e($company['address']); ?></p>
                </div>
                <div class="map-contact-list">
                    <span><i class="fa-solid fa-phone"></i><?php echo e($company['phone']); ?></span>
                    <span><i class="fa-solid fa-clock"></i><?php echo e($company['hours']); ?></span>
                </div>
            </div>
            <div class="map-embed-wrap" data-aos="fade-left" style="width:100%; max-width:100%; min-height:720px;">
                <iframe
                    title="Ban do GreenNest Landscape"
                    src="https://www.google.com/maps?q=<?php echo rawurlencode($company['address']); ?>&output=embed"
                    width="100%"
                    height="720"
    ...
    <div class="container position-relative">
        <div class="row align-items-center g-4">
            <div class="col-lg-8">
                ...
                <p>Gửi ảnh hiện trạng, GreenNest sẽ gợi ý nhóm cây, kích thước chậu và cách chăm sóc phù hợp.</p>
            </div>
            <div class="col-lg-4 text-lg-end">
                <a href="faq.php" class="btn btn-light px-4">Xem FAQ</a>
            </div>
        </div>
    </div>
</section>
