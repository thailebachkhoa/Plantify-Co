            ...
            <div class="container-fluid px-0">
                <div class="row align-items-center m-0 justify-content-between">
                    ...
                    <div class="col-4 col-md-6 d-flex justify-content-end align-items-center">
                        <ul class="notification-area d-flex align-items-center justify-content-end list-unstyled mb-0 gap-3" style="padding: 0; margin: 0;">
                            ...
                            <li>
                                <a href="<?= BASE_URL ?>" title="Xem website" aria-label="Xem website" class="text-dark text-decoration-none">
